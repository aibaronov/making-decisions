...
//If it is 80 degrees or above, and not raining, one should wear a t-shirt. 
...
//If it is between 60 and 80 degrees, and not raining, one should wear a hoodie. 
else if ((temperature > 60 && temperature < 80) && rain === false) {
  console.log("Wear a hoody");
}
//If it is 60 degrees or below and raining, one should wear a jacket and carry an umbrella. 
else if ((temperature <= 60) && rain === true) {
  console.log("Wear a jacket and carry an umbrella.");
}
//If it is 60 degrees or below and not raining, one should wear a warm coat
